...
// This file is almost entirely copied from github.com/aclements/go-gg/palette
// but simplified for the specific use-case here.
//
...
func (g rgbGradient) Map(x float64) color.Color {
	...
	// This is in between i and i+1. Just take the bottom one.
	//
	// TODO(mknyszek): Blend more smoothly between colors.
	return g.colors[i]
}
